...
public class BaseExcelUtil {
    ...
    public static void downloadExcelFile(String title,Map<String,String> headMap,
                                         JSONArray ja,HttpServletResponse response){
        try {
            ByteArrayOutputStream os = new ByteArrayOutputStream();
            BaseExcelUtil.exportExcelX(title,headMap,ja,null,0,os);
